...
class Retrieval :
    def __init__(self):
        ...
        self.QUERY_PROMPT = PromptTemplate(
            ...
            # template="""Vous êtes un assistant IA francais conçu pour générer cinq versions différentes de la question
            # utilisateur afin de récupérer des documents pertinents depuis une base de données vectorielle.
            # Votre objectif est d'aider l'utilisateur à surmonter les limites de la recherche par similarité basée
            # sur la distance en fournissant plusieurs perspectives de la question.
